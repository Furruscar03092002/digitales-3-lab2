...
CONTI       DB      'CAMBIAR COLOR,"Y"=SI,"N"=NO', '$';SE PREGUNTA SI SE DESEA VOLVER A IMPRIMIR 
                                              ;ALGUNA PALABRA
...
A20LOOP:
            ...
            CALL    Q20CURS
            CALL    ARROZ 
            CALL    EMPANADA          ;SE LLAMA LA VARIABLE ARROZZ EN EL CUAL EXHIBE EL
            ...
            JE      A22           ;SI ES IGUAL SE DEVUELVE AL INICIO DEL CODIGO PARA
                                    ;VOLVER A EJECUTAR EL CODIGO
            CMP     NAMEFLD,4EH     ;SE COMPARA LO INGRESADO CON "N" 
            JE      A20LOOP             ;SI ES IGUAL SE SALE YA QUE EL USUARIO NO DESEA 
...
;--------------------------------------------------
E10CODE     PROC    NEAR 
                   ;FIJA EL CURSOR EN LAS COORDENAS YA HECHAS CON LAS
...
Q10CLR          PROC    NEAR
            ...
            INT     10H
            MOV     AX,0600H
            MOV     BH,COLOR ;en este el 2 cambia el color del fondo
                           ; y el 4 cambio el color de la letra
            MOV     CX,061EH; EL 06 MANEJA DESDE DONDE SE EMPIEZA Y EL 18 EL ANCHO 
            MOV     DX,1332H ;IGUALMENTE ACA
            INT     10H
            RET
Q10CLR      ENDP
